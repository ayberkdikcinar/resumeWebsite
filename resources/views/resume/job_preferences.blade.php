                ...
                <fieldset>
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="desired_location">Location</label>
                                <select id="desired_location" name="desired_location" class="form-control" required>
                        ...
                        <a href="{{ route('resume.documents')}}" class="btn btn-primary next-step">Next Step</a>
                        <a href="{{ route('resume.courses')}}" class="btn btn-primary previous-step">Previous Step</a>
