...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{route('admin.pagesUpdatePost','contact-us')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="image-upload">
                    <label for="file-input">
                      <img src="{{asset('')}}{{$contactUs->image_url}}" width="250" id="uploadPreview"/>
                    </label>
